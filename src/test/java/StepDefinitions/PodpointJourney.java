...
public class PodpointJourney extends  BaseClass {
	...
	public void user_checks_six_compatible_extras_are_shown_and_select_any_compatible_extra() {
	MainPage mainPage = new MainPage();
	...
	public void user_Verify_Ensure_total_price_at_the_bottom_right_of_the_screen_matches_correctly() throws InterruptedException {
	MainPage mainPage = new MainPage();
